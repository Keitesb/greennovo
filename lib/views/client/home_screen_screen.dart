            ...
            children: [
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  padding: EdgeInsets.symmetric(
                    horizontal:
                        isWideScreen ? constraints.maxWidth * 0.05 : 8.0,
                  ),
              ...
              Expanded(
                child: Padding(
                  padding: EdgeInsets.symmetric(
                    horizontal:
                        isWideScreen ? constraints.maxWidth * 0.05 : 0.0,
                  ),
                  child: ProductListView(products: productController.products,
...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final productController = Provider.of<ProductController>(context);
    final products = productController.fetchProducts();
    final categories = productController.getCategories();
    final selectedCategory = productController.selectedCategory;
